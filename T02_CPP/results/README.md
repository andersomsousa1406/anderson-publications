...
This folder stores the recorded numerical artifacts currently attached to `T02_CPP`.

## Source

- Experiment: `experiments/t02_cpp_contraction_test.py`
- Simulation: `simulations/t02_cpp_regime_comparison.py`

## Files

- `summary.md`
- `t02_cpp_contraction_test.json`
- `t02_cpp_regime_comparison.json`
