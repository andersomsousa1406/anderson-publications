...
OUT_DIR = ROOT / "GONM" / "results" / "dimensional_sweep_100_to_1000"
SEEDS = [100, 137, 174]
DIMS = list(range(100, 1001, 100))
BUDGET = 1040
NOISE_STD = 0.18
...
def main() -> None:
    ...
    summary_lines = ["# Dimensional Sweep 100D to 1000D", "", f"Budget fixo: `{BUDGET}` | seeds: `{len(SEEDS)}`", ""]
    results = []
