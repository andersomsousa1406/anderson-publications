...
OUT_DIR = ROOT / "GONM" / "results" / "dimensionality_law_16d"
SEEDS = [100 + 37 * i for i in range(6)]
ACKLEY_DIMS = [2, 4, 8, 10, 16]
BUDGETS = [520, 1040]
...
def main() -> None:
    ...
    summary_lines.extend(["## 16D Phase-1 Sweep", ""])
    surface_10d = make_ackley_surface(16)
    for budget in BUDGETS:
        summary_lines.append(f"### `ackley_16d`, budget=`{budget}`")
