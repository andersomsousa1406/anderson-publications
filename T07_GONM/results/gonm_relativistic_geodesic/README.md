# gonm_relativistic_geodesic

This folder stores the exported result bundle for one `T07_GONM` experiment or simulation.

## Source

- Script or reference entry: `simulations/gonm_relativistic_geodesic.py`

## Image

![gonm_relativistic_geodesic](./gonm_relativistic_geodesic.png)

## Files

- `summary.md`
- `summary.json`
- `gonm_relativistic_geodesic.png`
