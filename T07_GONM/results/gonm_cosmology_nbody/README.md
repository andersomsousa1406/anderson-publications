# gonm_cosmology_nbody

This folder stores the exported result bundle for one `T07_GONM` experiment or simulation.

## Source

- Script or reference entry: `simulations/gonm_cosmology_nbody.py`

## Image

![gonm_cosmology_nbody](./gonm_cosmology_nbody.png)

## Files

- `summary.md`
- `summary.json`
- `gonm_cosmology_nbody.png`
