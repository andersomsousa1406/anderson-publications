# gonm_smart_grid_dispatch

This folder stores the exported result bundle for one `T07_GONM` experiment or simulation.

## Source

- Script or reference entry: `simulations/gonm_smart_grid_dispatch.py`

## Image

![gonm_smart_grid_dispatch](./gonm_smart_grid_dispatch.png)

## Files

- `summary.md`
- `summary.json`
- `gonm_smart_grid_dispatch.png`
