# gonm_satellite_attitude_control

This folder stores the exported result bundle for one `T07_GONM` experiment or simulation.

## Source

- Script or reference entry: `simulations/gonm_satellite_attitude_control.py`

## Image

![gonm_satellite_attitude_control](./gonm_satellite_attitude_control.png)

## Files

- `summary.md`
- `summary.json`
- `gonm_satellite_attitude_control.png`
