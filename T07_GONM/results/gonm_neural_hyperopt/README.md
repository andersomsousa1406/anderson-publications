# gonm_neural_hyperopt

This folder stores the exported result bundle for one `T07_GONM` experiment or simulation.

## Source

- Script or reference entry: `simulations/gonm_neural_hyperopt.py`

## Image

![gonm_neural_hyperopt](./gonm_neural_hyperopt.png)

## Files

- `summary.md`
- `summary.json`
- `gonm_neural_hyperopt.png`
